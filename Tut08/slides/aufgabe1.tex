...
\begin{frame}[fragile]{Well done, android.}\onslide<+->% init animation
    \begin{solve}
        \scriptsize%
        \ijava[style=files,linerange={27-36}]{sources/CubeCalculations.java}\vspace{-\abovedisplayskip}
        \ijava[style=files,linerange={69-73}]{sources/CubeCalculations.java}
    \end{solve}
\end{frame}
\resetsolve
\begin{frame}[fragile]{Well done, android.}\onslide<+->% init animation
    \begin{solve}
        \scriptsize%
        \ijava[style=files,linerange={37,44-46,48-57,66-68}]{sources/CubeCalculations.java}
    \end{solve}
    \vspace{-1em}
\end{frame}
\resetsolve
\begin{frame}[fragile]{Well done, android.}\onslide<+->% init animation
    \begin{solve}
        \scriptsize%
        \ijava[style=files,linerange={75-88}]{sources/CubeCalculations.java}
    \end{solve}
\end{frame}
\resetsolve
\begin{frame}[fragile]{Well done, android.}\onslide<+->% init animation
